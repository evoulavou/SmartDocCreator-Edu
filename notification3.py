    ...
    return {
        ...
        's5_Πρ_τοποθέτηση αποσπασμένων': {
            ...
            'Εισαγωγή': (
                ...
                lambda r: (
                    f'τοποθετηθήκατε στο {r["ΣΧΟΛΕΙΟ ΠΡΟΣΩΡΙΝΗΣ ΤΟΠΟΘΕΤΗΣΗΣ"]} '
                    f'({_h(r, "ΩΡΕΣ ΠΡΟΣΩΡΙΝΗΣ ΤΟΠΟΘΕΤΗΣΗΣ")} ώρες την εβδομάδα) και διατεθήκατε:'
                    if _has_disp(r) else
                    f'τοποθετηθήκατε στο {r["ΣΧΟΛΕΙΟ ΠΡΟΣΩΡΙΝΗΣ ΤΟΠΟΘΕΤΗΣΗΣ"]} '
                    f'({_h(r, "ΩΡΕΣ ΠΡΟΣΩΡΙΝΗΣ ΤΟΠΟΘΕΤΗΣΗΣ")} ώρες την εβδομάδα) '
                    f'από {hm} έως τη λήξη του διδακτικού έτους.'
                ),
            ),
            ...
            'Τροποποίηση': (
                ...
                lambda r: (
                    f'τροποποιήθηκε η τοποθέτηση και η διάθεσή σας, καθώς '
                    f'τοποθετηθήκατε στο {r["ΣΧΟΛΕΙΟ ΠΡΟΣΩΡΙΝΗΣ ΤΟΠΟΘΕΤΗΣΗΣ"]} '
                    f'({_h(r, "ΩΡΕΣ ΠΡΟΣΩΡΙΝΗΣ ΤΟΠΟΘΕΤΗΣΗΣ")} ώρες την εβδομάδα) και διατεθήκατε:'
                    if _has_disp(r) else
                    f'τροποποιήθηκε η τοποθέτησή σας και τοποθετηθήκατε στο '
                    f'{r["ΣΧΟΛΕΙΟ ΠΡΟΣΩΡΙΝΗΣ ΤΟΠΟΘΕΤΗΣΗΣ"]} '
                    f'({_h(r, "ΩΡΕΣ ΠΡΟΣΩΡΙΝΗΣ ΤΟΠΟΘΕΤΗΣΗΣ")} ώρες την εβδομάδα) '
                    f'από {hm} έως τη λήξη του διδακτικού έτους.'
                ),
            ),
...
def notifications3(filename: str) -> None:
    ...
    # Προσθήκη μίας ημέρας στην ημερομηνία παρουσίασης
    greek_days = [
        'Δευτέρα',
        'Τρίτη',
        'Τετάρτη',
